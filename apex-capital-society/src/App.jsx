...
function LearningTopics() {
  ...
  return (
    <section
      id="topics"
      className="relative scroll-mt-28 overflow-hidden border-y border-white/10 bg-black/18 px-5 py-24 lg:px-8"
    >
        ...
        >
          ...
          <div className="grid gap-4 sm:grid-cols-2">
            {topics.map((topic, index) => (
              <motion.article
                key={topic.title}
                className="group min-h-[230px] rounded-[2rem] border border-white/10 bg-white/[0.045] p-6 shadow-glass backdrop-blur-2xl transition hover:border-gold/35"
